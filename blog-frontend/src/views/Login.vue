<template>
  <div class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="glass-card p-8 w-full max-w-md animate-fade-in-up">
      <h2 class="text-3xl font-bold text-center mb-8 gradient-text">欢迎回来</h2>
      ...
      <div class="text-center mt-4">
        ...
        <router-link to="/register" class="text-primary-500 hover:text-primary-400 ml-1 font-medium">立即注册</router-link>
        <span class="mx-2 text-gray-400">|</span>
        <router-link to="/forgot-password" class="text-gray-500 hover:text-primary-400">忘记密码？</router-link>
      </div>
      <div class="mt-8">
        <div class="relative">
          <div class="absolute inset-0 flex items-center"><div class="w-full border-t border-gray-200/50 dark:border-gray-600/50"></div></div>
          <div class="relative flex justify-center text-sm"><span class="px-3 glass-light rounded-full text-gray-500 dark:text-gray-400">或使用第三方登录</span></div>
        </div>
        <div class="mt-6 flex gap-4">
          <button class="flex-1 glass-btn py-3 rounded-xl flex items-center justify-center gap-2 hover:scale-105 transition-transform" @click="loginWithGithub">
