...
public interface FollowMapper extends BaseMapper<Follow> {
     ...
     * 一次SQL查询互关好友，消除N+1问题
     */
    @Select("SELECT u.id, u.username, u.nickname, u.avatar, u.bio FROM follow f1 " +
            "JOIN follow f2 ON f1.following_id = f2.follower_id AND f2.following_id = f1.follower_id " +
